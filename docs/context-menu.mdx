...
This is a shortcut to using the [`/resolve`](managing-suggestions.md) command. You can use this to resolve the suggestion with any resolution type / response / anonymously.

...
- [Resolve suggestion](#resolve-suggestion)
- [View down voters](#view-down-voters)
- [View up voters](#view-up-voters)
- [View voters](#view-voters)

You will need the `Send Messages` permission in the channel you're doing this in. Otherwise, the "Apps" sub-menu will not display.

## Resolve Suggestion

This is a shortcut to using the [`/resolve`](managing-suggestions.mdx) command. You can use this to resolve the suggestion with any resolution type / response / anonymously.
